...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/product/reGetPageData?curr=1" class="blue">
                主营产品推荐
            </a><br>
        ...
        <!-- 右侧内容 -->
        <div class="right r">
            <p class="title">主营推荐产品</p>
            <div class="rig_main">
                    <c:forEach items="${pb.res}" var="r">
                        <div class="product l">
                                <img src="${r.img}" alt="">
                                <div class="pro_p">
                                    <p>${r.title}</p>
                                    <p>${r.setitle}</p>
                                    <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/product/reFindById?id=${r.id}">查看详情</a> </button>
                                </div>
                        </div>
                    </c:forEach>
            ...
            <div class="page">
                <a href="${pageContext.request.contextPath }/product/reGetPageData?curr=${pb.currentPage==1?1:pb.currentPage-1}">上一页</a>
                <a href="${pageContext.request.contextPath }/product/reGetPageData?curr=1">1</a>
                <a href="${pageContext.request.contextPath }/product/reGetPageData?curr=2">2</a>
                <a href="${pageContext.request.contextPath }/product/reGetPageData?curr=${pb.currentPage+1}">下一页</a>
            </div>
        </div>
