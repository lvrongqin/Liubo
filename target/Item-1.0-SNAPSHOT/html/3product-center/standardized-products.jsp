...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/product/orGetPageData?curr=1" >
                定制化产品
            </a><br>
            <a href="${pageContext.request.contextPath }/product/stGetPageData?curr=1" class="blue">
                标准化产品
            </a>
        </div>
        ...
        <!-- 右侧内容 -->
        <div class="right r">
            <p class="title">标准化产品</p>

            <div class="rig_main">
                <c:forEach items="${pb.standards}" var="st">
                    <div class="product l">
                        <img src="${st.img}" alt="">
                        <div class="pro_p">
                            <p>${st.title}</p>
                            <p>${st.setitle}</p>
                            <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/product/stFindById?id=${st.id}">查看详情</a> </button>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="page">
                <a href="${pageContext.request.contextPath }/product/stGetPageData?curr=${pb.currentPage==1?1:pb.currentPage-1}">上一页</a>
                <a href="${pageContext.request.contextPath }/product/stGetPageData?curr=1">1</a>
                <a href="${pageContext.request.contextPath }/product/stGetPageData?curr=2">2</a>
                <a href="${pageContext.request.contextPath }/product/stGetPageData?curr=${pb.currentPage+1}">下一页</a>
            </div>
        </div>
