...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/recruit/marGetPageData?curr=1" class="blue">
                市场部
            </a><br>
            <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=1">
                研发部
            </a><br>
            <a href="${pageContext.request.contextPath }/recruit/manGetPageData?curr=1" >
                经营部
            </a>
        </div>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                <c:forEach items="${pb.markets}" var="m">
                    <div class="news l">
                        <a href="${pageContext.request.contextPath }/recruit/marFindById?id=${m.id}">${m.title}</a>
                        <div class="scal_img">
                            <img src="${m.img}" alt="">
                        </div>
                        <div class="news_foot">
                            <span>${m.time}</span>
                            <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/recruit/marFindById?id=${m.id}">查看详情</a> </button>
                        </div>
                    </div>
                </c:forEach>
