...
<body>
    ...
    <div class="main">
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                <c:forEach items="${pb.honors}" var="h">
                    <div class="news l">
                        <a href="${pageContext.request.contextPath }/news/hoFindById?id=${h.id}">${h.title}</a>
                        <div class="scal_img">
                            <img src="${h.img}" alt="">
                        </div>
                        <div class="news_foot">
                            <span>${h.time}</span>
                            <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/news/hoFindById?id=${h.id}">查看详情</a> </button>
                        </div>
                    </div>
                </c:forEach>
