...
<body>
    ...
    <div class="head">
        <div class="head_blo">
            ...
            <ul class="nav_n r">
                ...
                <li><button  class="action"><a href="${pageContext.request.contextPath }/serv/seGetPageData?curr=1"  target="_top">客户服务</a></button>
    ...
    <div class="con-img">
        <img src="${pageContext.request.contextPath }/images/upload/banner.jpg" alt="">
    </div>  
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/customer-service.jsp" class="blue">
                客户服务
            </a><br>
        </div>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                <c:forEach items="${pb.ses}" var="e">
                    <ul class="dataWrapper clearfix">
                        <li><a href="${pageContext.request.contextPath }/serv/findByIdService?id=${e.id}"><span class="leftMod">${e.title}</span><span class="rightMod">${e.time}</span></a></li>
                    </ul>
                </c:forEach>
            </div>
            <div class="page">
                <a href="${pageContext.request.contextPath }/news/seGetPageData?curr=${pb.currentPage==1?1:pb.currentPage-1}">上一页</a>
                <a href="${pageContext.request.contextPath }/news/seGetPageData?curr=1">1</a>
                <a href="${pageContext.request.contextPath }/news/seGetPageData?curr=2">2</a>
                <a href="${pageContext.request.contextPath }/news/seGetPageData?curr=${pb.currentPage+1}">下一页</a>
            </div>
            </div>
