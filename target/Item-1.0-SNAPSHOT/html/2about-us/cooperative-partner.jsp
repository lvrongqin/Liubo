...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/html/2about-us/cooperative-partner.jsp" class="blue">
                合作伙伴
            </a>
        </div>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                <img src="${pageContext.request.contextPath }/images/upload/wd.jpg" alt="">
            </div>
        </div>
    </div>
