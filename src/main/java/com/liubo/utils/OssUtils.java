...
public class OssUtils {
    ...
    private static String accessId = "LTAI5tGZTBBzQS2N43fkabcd";
    private static String accessKey = "RpJofXZ0RsjGb100Pjs45EADtNdcba";
    private static String privateBucket = "liubo123";
