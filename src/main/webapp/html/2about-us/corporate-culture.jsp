...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/html/2about-us/corporate-culture.jsp" class="blue">
                企业文化
            </a><br>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                <img src="${pageContext.request.contextPath }/images/upload/culture.png" alt="">
                <img src="${pageContext.request.contextPath }/images/upload/culture1.png" alt="">
                <img src="${pageContext.request.contextPath }/images/upload/culture2.png" alt="">
            </div>
        </div>
    </div>
