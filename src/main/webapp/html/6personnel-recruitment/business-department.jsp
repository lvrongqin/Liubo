...
<body>
    ...
    <div class="con-img">
        <img src="${pageContext.request.contextPath }/images/upload/hezuo.jpg" alt="">
    </div>  
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/recruit/marGetPageData?curr=1">
                市场部
            </a><br>
            <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=1">
                研发部
            </a><br>
            <a href="${pageContext.request.contextPath }/recruit/manGetPageData?curr=1" class="blue">
                经营部
            </a>
        </div>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                ...
                <c:forEach items="${pb.manages}" var="v">
                    <div class="news l">
                        <a href="${pageContext.request.contextPath }/recruit/manFindById?id=${m.id}">${v.title}</a>
                        <div class="scal_img">
                            <img src="${v.img}" alt="">
                        </div>
                        <div class="news_foot">
                            <span>${v.time}</span>
                            <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/recruit/manFindById?id=${v.id}">查看详情</a> </button>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="page">
                <a href="${pageContext.request.contextPath }/recruit/marGetPageData?curr=${pb.currentPage==1?1:pb.currentPage-1}">上一页</a>
                <a href="${pageContext.request.contextPath }/recruit/marGetPageData?curr=1">1</a>
                <a href="${pageContext.request.contextPath }/recruit/marGetPageData?curr=2">2</a>
                <a href="${pageContext.request.contextPath }/recruit/marGetPageData?curr=${pb.currentPage+1}">下一页</a>
            </div>
            </div>
        </div>
