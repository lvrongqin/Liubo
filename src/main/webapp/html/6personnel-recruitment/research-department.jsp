...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=1" class="blue">
                研发部
            </a><br>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                ...
                <c:forEach items="${pb.devs}" var="d">
                    <div class="news l">
                        <a href="${pageContext.request.contextPath }/recruit/devFindById?id=${d.id}">${d.title}</a>
                        <div class="scal_img">
                            <img src="${d.img}" alt="">
                        </div>
                        <div class="news_foot">
                            <span>${d.time}</span>
                            <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/recruit/devFindById?id=${d.id}">查看详情</a> </button>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="page">
                <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=${pb.currentPage==1?1:pb.currentPage-1}">上一页</a>
                <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=1">1</a>
                <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=2">2</a>
                <a href="${pageContext.request.contextPath }/recruit/devGetPageData?curr=${pb.currentPage+1}">下一页</a>
            </div>
            </div>
        </div>
