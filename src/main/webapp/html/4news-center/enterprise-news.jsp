...
<body>
    ...
    <div class="main">
        ...
        <div class="con_left l">
            ...
            <a href="${pageContext.request.contextPath }/news/newsGetPageData?curr=1" class="blue">
                企业新闻
            </a><br>
            <a href="${pageContext.request.contextPath }/news/hoGetPageData?curr=1">
                企业荣誉
            </a><br>
            <a href="${pageContext.request.contextPath }/news/dyGetPageData?curr=1">
                行业动态
            </a>
        </div>
        ...
        <div class="right r">
            ...
            <div class="rig_main">
                <c:forEach items="${pb.news}" var="n">
                    <div class="news l">
                        <a href="${pageContext.request.contextPath }/news/newsFindById?id=${n.id}">${n.title}</a>
                        <div class="scal_img">
                            <img src="${n.img}" alt="">
                        </div>
                        ...
                        <div class="news_foot">
                            <span>${n.time}</span>
                            <button class="custom-btn btn-16 r"><a href="${pageContext.request.contextPath }/news/newsFindById?id=${n.id}">查看详情</a> </button>
                        </div>
                    </div>
                </c:forEach>
                ...
                <div class="page">
                    <a href="${pageContext.request.contextPath }/news/newsGetPageData?curr=${pb.currentPage==1?1:pb.currentPage-1}">上一页</a>
                    <a href="${pageContext.request.contextPath }/news/newsGetPageData?curr=1">1</a>
                    <a href="${pageContext.request.contextPath }/news/newsGetPageData?curr=2">2</a>
                    <a href="${pageContext.request.contextPath }/news/newsGetPageData?curr=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}">下一页</a>
                </div>
        </div>
